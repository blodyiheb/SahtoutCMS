...
<head>
    ...
    <style>
        ...
        /* Search button - Green theme matching 3v3 nav button */
        #search-btn {
            cursor: pointer;
        ...
        <div class="glass-container">
            ...
            <form method="get" class="mb-8 flex flex-col sm:flex-row justify-center items-center gap-3">
                ...
                <button 
                    type="submit"
                    id="search-btn"
                    class="px-6 py-2.5 rounded-lg transition-all duration-300 shadow-lg shadow-[rgba(34,197,94,0.3)] flex items-center gap-2"
                >
                    <i class="fas fa-search"></i> <?php echo translate('arena_3v3_search_btn', 'Search'); ?>
                </button>

                <?php if ($search !== ''): ?>
                    <a href="<?php echo $base_path; ?>armory/arena_3v3" class="reset-btn px-5 py-2.5 rounded-lg transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-times"></i> <?php echo translate('arena_3v3_reset_btn', 'Reset'); ?>
                    </a>
                <?php endif; ?>
            </form>
            ...
            <div class="table-container overflow-x-auto border border-[rgba(201,162,39,0.15)] shadow-2xl">
                <table class="w-full text-sm md:text-base text-center min-w-[700px]">
                    <thead class="bg-gradient-to-r from-[rgba(201,162,39,0.9)] to-[rgba(160,130,30,0.9)] text-amber-100 uppercase text-xs md:text-sm">
                        <tr>
                            <th class="py-4 px-3 md:px-6 font-bold whitespace-nowrap"><?php echo translate('arena_3v3_rank', 'Rank'); ?></th>
                            <th class="py-4 px-3 md:px-6 font-bold text-left whitespace-nowrap"><?php echo translate('arena_3v3_name', 'Name'); ?></th>
                            <th class="py-4 px-3 md:px-6 font-bold whitespace-nowrap"><?php echo translate('arena_3v3_faction', 'Faction'); ?></th>
                            <th class="py-4 px-3 md:px-6 font-bold whitespace-nowrap"><?php echo translate('arena_3v3_wins', 'Wins'); ?></th>
                            <th class="py-4 px-3 md:px-6 font-bold whitespace-nowrap"><?php echo translate('arena_3v3_losses', 'Losses'); ?></th>
                            <th class="py-4 px-3 md:px-6 font-bold whitespace-nowrap"><?php echo translate('arena_3v3_winrate', 'Winrate'); ?></th>
                            <th class="py-4 px-3 md:px-6 font-bold whitespace-nowrap"><?php echo translate('arena_3v3_rating', 'Rating'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
