    ...
    <div class="container mx-auto max-w-7xl px-2 sm:px-4">
        ...
        <div class="bg-black/30 backdrop-blur-md rounded-2xl border border-amber-500/30 p-6 md:p-10 shadow-2xl">
            ...
            <form method="get" class="mb-8 flex flex-col sm:flex-row justify-center items-center gap-3">
                ...
                >
                    <?php echo translate('arena_2v2_search_btn', 'Search'); ?>
                </button>

                <?php if ($search !== ''): ?>
                    <a href="<?php echo $base_path; ?>armory/arena_2v2" class="px-5 py-2.5 rounded-lg bg-gray-600/80 text-white hover:bg-gray-500/80 transition-all duration-300 hover:scale-105">
                        <?php echo translate('arena_2v2_reset_btn', 'Reset'); ?>
                    </a>
                <?php endif; ?>
            </form>
            ...
            <div class="table-container overflow-x-auto rounded-xl shadow-2xl border border-amber-500/20">
                <table class="w-full text-sm md:text-base text-center">
                    <thead class="bg-gradient-to-r from-amber-600/80 to-amber-700/80 text-amber-100 uppercase text-xs md:text-sm">
                        <tr>
                            <th class="py-4 px-4 md:px-6 font-bold"><?php echo translate('arena_2v2_rank', 'Rank'); ?></th>
                            <th class="py-4 px-4 md:px-6 font-bold text-left"><?php echo translate('arena_2v2_name', 'Name'); ?></th>
                            <th class="py-4 px-4 md:px-6 font-bold"><?php echo translate('arena_2v2_faction', 'Faction'); ?></th>
                            <th class="py-4 px-4 md:px-6 font-bold"><?php echo translate('arena_2v2_wins', 'Wins'); ?></th>
                            <th class="py-4 px-4 md:px-6 font-bold"><?php echo translate('arena_2v2_losses', 'Losses'); ?></th>
                            <th class="py-4 px-4 md:px-6 font-bold"><?php echo translate('arena_2v2_winrate', 'Winrate'); ?></th>
                            <th class="py-4 px-4 md:px-6 font-bold"><?php echo translate('arena_2v2_rating', 'Rating'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
